...
public class MemberService {
    ...
    /**
     * DAO 객체에 dto를 전달하여 insert SQL을 수행하도록 요청하고 수행된 결과 행을 받아오고 반환하는 메서드
     * 
    ...
    /**
     * DAO 객체에 userid를 전달하고 select SQL을 수행하여 동일한 아이디를 갖는 데이터가 있는지 조회하고 그 여부를 반환하는
     * 메서드
     * 
    ...
    /**
     * DAO 객체에 아이디와 비밀번호를 담은 HashMap 객체를 전달하여 아이디와 비밀번호를 일치할 경우 해당 MemberDTO 엔티티 객체를
     * 받아 반환하는 메서드
     * 
