...
<script>
  window.onload = () => {
    ...
    same.addEventListener('change', e => {
      if (e.target.checked) {
        document.querySelector('#orderName').value = document.querySelector('#mname').value;
        document.querySelector('#sample4_postcode').value = document.querySelector('#mpost').value;
        document.querySelector('#sample4_roadAddress').value = document.querySelector('#maddress1').value;
        document.querySelector('#sample4_jibunAddress').value = document.querySelector('#maddress2').value;
        document.querySelector('#phone').value = document.querySelector('#mphone').value;
      }
    })
  }
</script>
...
<!-- 수정 부분 -->
<!-- hidden 처리-->
<form action="loginCheck/orderDone" method="GET">
        ...
        <tr>
            <td>
                <table width="100%" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="td_default" width="80" align="center">${ cart.num }
                        </td>
                        ...
                        <td class="td_default" width="300" style='padding-left: 30px'>
                            ...
                            <font size="2" color="#665b5f">
                                [옵션 : 사이즈(${ cart.gSize }), 색상(${ cart.gColor })]
                            </font></td>
                    ...
                    <tr>
                        ...
                        <td height="35" class="td_default">
                            <input class="input_default" type="text" id="mname" size="20"
                                   maxlength="20" value="${ user.username }"></input>
                        </td>
                    </tr>
                    <tr>
                        <td height="35" class="td_default">
                        ...
                        <td height="35" class="td_default">
                            <input class="input_default" type="text" id="mpost" size="6"
                                   maxlength="6" value="${ user.post }" readonly>
                    ...
                    <tr>
                        ...
                        <td height="35" class="td_default">
                            <input class="input_default" type="text" id="maddress1" size="35"
                                   maxlength="200" value="${ user.addr1 }" readonly></input><br>
                            <input class="input_default" type="text" id="maddress2" size="35"
                                   maxlength="200" value="${ user.addr2 }" readonly></input>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height="35" class="td_default">
                            <input class="input_default" type="text" id="mphone" size="15"
                                   maxlength="15" value="${user.phone1}${user.phone2}${user.phone3}" />
