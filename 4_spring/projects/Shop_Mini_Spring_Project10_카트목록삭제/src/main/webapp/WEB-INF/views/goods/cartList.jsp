...
<script type="text/javascript">
  $(() => {
    ...
    $('#delAllCart').on('click', () => {
      const num = [];
      $('input:checkbox[name="check"]:checked').each((index, elem) => {
        num.push($(elem).val());
      });

      location.href = 'cartAllDel?data=' + num;
    });

    $('#delAllCart2').on('click', () => {
      $('.check').each((index, elem) => {
    ...
    $('.orderBtn').on('click', (e) => {
      location.href = 'CartOrderConfirmServlet?num=' + e.target.dataset.xxx
    });
...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
    ...
    <tr>
        <td align="center" colspan="5">
            ...
            <a class="a_black" href="#" id="delAllCart">
                선택 삭제하기
            </a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a class="a_black" href="#" id="delAllCart2">
                전체 삭제하기
            </a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a class="a_black" href="main">
                계속 쇼핑하기
            </a>&nbsp;&nbsp;&nbsp;&nbsp;
        </td>
    </tr>
